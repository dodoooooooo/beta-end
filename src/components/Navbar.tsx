    ...
    <nav className='flex items-center justify-between p-5 bg-white shadow-md h-[60px]'>
      ...
      <div className='flex items-center flex-grow max-w-lg sm:w-auto'>
        ...
        <input
          type='text'
          placeholder='Search...'
          className='flex-grow p-2 mr-[10px] bg-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 '
        />
      </div>
      {/* 右邊的用戶圖標和名稱 */}
      <div className='flex items-center space-x-10'>
        ...
        <div className='flex items-center'>
          <span className='mr-[2px] text-black'>{User.name}</span>
